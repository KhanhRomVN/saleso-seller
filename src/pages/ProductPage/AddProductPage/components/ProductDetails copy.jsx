...
const ProductDetails = ({ category, onDetailsChange }) => {
  ...
  return (
    <Card className="product-details-card" style={{ background: '#f0f2f5', padding: '24px', borderRadius: '8px' }}>
      <Form form={form} onFinish={onFinish} layout="vertical">
        ...
        <Button onClick={showModal} icon={<PlusOutlined />} style={{ marginBottom: '16px' }}>
