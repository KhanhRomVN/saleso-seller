...
import { Package2, Search, ChevronDown, Star, DollarSign } from "lucide-react";
...
export default function OrderPage() {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="container mx-auto p-4  text-gray-100 h-screen"
    >
      ...
      <AnimatePresence>
        ...
        >
          <Table>
            <TableHeader>
              <TableRow className="bg-blue_background_opacity">
            ...
            <TableBody className="border">
              {filteredOrders.map((order) => (
                <TableRow key={order._id} className="border-b border-gray-700">
                  ...
                  <TableCell>{order.customer_username}</TableCell>
        ...
        <DialogContent className="bg-gray-800 text-gray-100">
          ...
          {productDetails && (
            ...
            >
              ...
              <h3 className="font-bold mt-4 mb-2 text-purple-400">Variants:</h3>
              <ul>
