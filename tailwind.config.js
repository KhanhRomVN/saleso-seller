  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        yellow_background_opacity: "var(--yellow-background-opacity)",
        pink_background_opacity: "var(--pink-background-opacity)",
        purple_background_opacity: "var(--purple-background-opacity)",
        orange_background_opacity: "var(--orange-background-opacity)",
        gray_background_opacity: "var(--gray-background-opacity)",
